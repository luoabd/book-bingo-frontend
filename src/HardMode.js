...
const HardMode = ({ stateChanger, metaData, id }) => {
  const [hm, setHm] = useState(metaData[id].hardMode);
  ...
  return (
    <div className="flex justify-center text-2xl">
      <label className="relative inline-flex items-center mr-5 cursor-pointer">
        <input type="checkbox" value="" className="sr-only peer" onChange={handleChange} checked={hm ? true : false} />
